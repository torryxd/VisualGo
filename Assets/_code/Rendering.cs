...
//         {
//             Text = new Text(str, new Font("C:/Windows/Fonts/Arial.ttf"));
//         }
//         public override void Update()
//         {
...
//             back.Shape.FillColor = new Color(255, 165, 0);
//             AddShape(back);
...
//             place.Shape.FillColor = new Color(255, 165, 0);
...
//             _scoreObjects[0] = new TextObject("Score: 0");
//             _scoreObjects[0].Text.FillColor = Color.Black;
//             _scoreObjects[1] = new TextObject("Score: 0");
...
//             TextObject passText = new TextObject("Pass");
...
//             passText.Text.FillColor = Color.Black;
...
//                     else endText = "DRAW";
//                     TextObject finishText = new TextObject(endText);
//                     finishText.Text.Position = new Vector2f(250, 250);
//                     finishText.Text.FillColor = Color.Red;
